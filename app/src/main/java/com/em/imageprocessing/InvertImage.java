package com.em.imageprocessing;
 ...
 */
public class InvertImage extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.invert_image);

        initView();


        Bitmap srcBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.sample1);

        Bitmap finalBitmap = applyReflection(srcBitmap);
    ...
    public static Bitmap gammaCorrection(Bitmap src, double red, double green, double blue)
    {
        // create output image
